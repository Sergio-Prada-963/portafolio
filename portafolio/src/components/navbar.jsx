...
export const Navbar = () => {
  return (
    <>
      <div className='items-center w-full text-black flex flex-row justify-between pl-8 pt-2 pb-2 pr-8 dark:text-white'>
        Aquí va el nav-bar
        {/* <button id='toggle-dark-mode' className="bg-btn_toggle dark:bg-btn_toggle_dark">Cambiar Modo</button> */}
        {/* <button id='toggle-dark-mode' className='bg-btn_toggle dark:bg-btn_toggle_dark'>
          Cambiar Modo
        </button> */}
        <div>
