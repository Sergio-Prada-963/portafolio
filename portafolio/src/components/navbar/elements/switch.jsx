...
import LogoBlack from "../../../assets/svg/logos/logo_dark.svg"
import Menu_icon from "../../../assets/svg/menus/menu.svg"
import Menu_icon_dark from "../../../assets/svg/menus/menu_dark.svg"
...
function Switch(props) {
  ...
  useEffect(() => {
    ...
    const handleDarkModeChange = () => {
      ...
      if (body.dataset.mode === "light") {
        ...
        props.setLogoSvg(Logo)
        props.setMenuSvg(Menu_icon)
      } else {
        body.classList.remove("body-light")
        body.classList.add("body-dark")
        BACKGROUND_COLOR = "rgba(30, 41, 59)"
        props.setLogoSvg(LogoBlack)
        props.setMenuSvg(Menu_icon_dark)
      }
    }
  ...
  return (
    <div>
      <label className='toggle border-black rounded-full dark:border-white ' htmlFor='switch'>
        <input id='switch' className='input' type='checkbox' />
        <div className='icon icon--moon'>
          <img src={Theme_moon} alt='Moon SVG' />
        </div>
        <div className='icon icon--sun'>
          <img src={Theme_sun} alt='Sun SVG' />
        </div>
      </label>
    </div>
  )
