				...
				<div class="container">
					<div class="about-grid reveal">
						...
						<div class="about-text">
							...
							<p>
								Me especializo en construir soluciones integrales de extremo a extremo, desde interfaces con <strong>PHP</strong>, <strong>React</strong> y <strong>Flutter</strong> hasta backends robustos con <strong>Python</strong>, <strong>Node.js</strong> y <strong>Express</strong>, bases de datos y modelos de IA integrados con <strong>LangChain & LLMs</strong>.
							</p>
							<p>
