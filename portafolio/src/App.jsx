...
//   if (body.dataset.mode === "light" || !prefersDark.matches) {
//     body.dataset.mode = "dark";
//     body.classList.add("dark");
//     // Agrega aquí la lógica para cambiar otros estilos o variables según el modo oscuro
//   } else {
//     body.dataset.mode = "light";
//     body.classList.remove("dark");
//     // Agrega aquí la lógica para cambiar otros estilos o variables según el modo claro
//   }
// };
...
// Initialize
  ...
  // Inicializar el modo según la preferencia del sistema
  console.log("eooo", prefersDark.matches)
  ...
  loop();
          ...
          // Agregar un evento al botón solo si se encuentra en el DOM
          toggleButton.addEventListener("click",()=>{ toggleDarkMode; loop()});
...
//     return () => {
//       if (toggleButton) {
//         toggleButton.removeEventListener("click",()=>{ toggleDarkMode; loop()});
//       }
//     };
  ...
  return (
    ...
    <div className="bg-white dark:bg-black prueva ">
      <p className="text-black dark:text-white">leloooo</p>
    </div> */}
      <Welcome />
      <Navbar />
